...
const Widget1 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            ...
            let data1 = { "graphs": [{ "balloonText": "Văn bản đến trong tháng [[category]]: <b>[[value]]</b>", "fillAlphas": 0.9, "lineAlpha": 0.2, "title": "", "type": "column", "valueField": "value1" }, { "balloonText": "Văn bản đi trong tháng [[category]]: <b>[[value]]</b>", "fillAlphas": 0.9, "lineAlpha": 0.2, "title": "", "type": "column", "valueField": "value2" }], "items": [{ "category": "8/2022", "value1": 0, "value2": 3 }, { "category": "7/2022", "value1": 19, "value2": 13 }, { "category": "6/2022", "value1": 4, "value2": 9 }, { "category": "5/2022", "value1": 15, "value2": 4 }, { "category": "4/2022", "value1": 1, "value2": 1 }, { "category": "3/2022", "value1": 184, "value2": 110 }] }
            let dataBar = []
            let cateBar = []
                    ...
                    <div className='col-xl-8'>
                        <div className='card shadow-sm mt-3' id='QLVB-SLVBDI'>
                            <div className='p-0 rounded-0 border-0 card-header'>
                                <h3 className='card-title fw-normal text-primary fs-4 px-4'>QLVB - Số lượng văn bản đến đi cơ quan</h3>
                            </div>
                                ...
                                <div className={`col-xl-6 col-md-6 mt-${index1 < 2 ? 3 : 6}`} key={index1}>
                                    ...
                                    >
                                        <div className='card-body p-6 text-center'>
                                            ...
                                            <p className='m-0 mt-2 text-gray-600 fs-6 text-1line' title={j.Name}>PAHT - {j.Name}</p>
                                        </div>
                                    </div>
                                </div>
                            )) ?? ''}
