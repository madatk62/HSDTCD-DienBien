...
const Widget3 = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            let data1 = [{"category":"Chưa thực hiện","value":4},{"category":"Đang thực hiện","value":26},{"category":"Đã thực hiện","value":12}]
            let dataPie = []
            data1.map(h => {
                dataPie.push({
                    name: h?.category ?? '',
            ...
            let data3 = [{"category":"Chưa thực hiện","value":264},{"category":"Đang thực hiện","value":104},{"category":"Đã thực hiện","value":71}]
            let dataPie3 = []
            data3.map(h => {
                dataPie3.push({
                    name: h?.category ?? '',
                    ...
                    <div className='row'>
                        <div className='col-xl-6 border-end border-gray-30'>
                            <div className='p-0 rounded-0 border-0 card-header'>
                                <h3 className='card-title fw-normal text-primary fs-4 px-4'>CDDH - Văn bản chỉ đạo</h3>
                            </div>
                        ...
                        <div className='col-xl-6 border-end border-gray-30'>
                            <div className='p-0 rounded-0 border-0 card-header'>
                                <h3 className='card-title fw-normal text-primary fs-4 px-4'>CDDH - Theo dõi nhiệm vụ</h3>
                            </div>
                            <div className='card-body p-4 px-xl-6 pt-xl-0'>
                                <div className='align-items-center'>
                                    <div className='highchart-nv'>
